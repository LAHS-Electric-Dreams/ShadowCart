...
class Lidar(object):
	def __init__(self, front_angle, num_mins_to_average, usb_address, scan_speed, zero_angle):
		...
		# Default speed is what the LiDAR spins at when it is idle and not colelcting data; it sins at scan for one data collection. 
		self.scan_speed = scan_speed

		# Set this to null for now, initialize it later as when one initializes an RPLidar, it can immediately start the motor.
		self.rplidar = None
